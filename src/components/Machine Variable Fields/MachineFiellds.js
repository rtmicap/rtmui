export const machineFields = {
    Cutting: {
        ...
        CircularSaw: [
            ...
            { name: 'max_diameter_round_in_mm', label: 'Max Diameter Round', type: 'text', placeholder: "Dimension in mm", pattern: /^(?:\d{1,4}(?:\.\d{1,2})?|\.\d{1,2})$/, maxLength: 7 },
            { name: 'min_square_in_mm', label: 'Min Square', type: 'text', placeholder: "Dimension in mm", pattern: /^(?:\d{1,4}(?:\.\d{1,2})?|\.\d{1,2})$/, maxLength: 7 },
            { name: 'max_square_in_mm', label: 'Max Square', type: 'text', placeholder: "Dimension in mm", pattern: /^(?:\d{1,4}(?:\.\d{1,2})?|\.\d{1,2})$/, maxLength: 7 },
    ...
    Drilling: {
        ConventionalDrillingMachine: [
            ...
            { name: 'spindle_tape', label: 'Spindle Tape', type: 'text', placeholder: "Dimension in MT3", pattern: /^(?:\d{1,4}(?:\.\d{1,2})?|\.\d{1,2})$/, maxLength: 7 },
    ...
    Turning: {
        ...
        Automat: [
            ...
            { name: 'repeatability', label: 'Repeatability', type: 'text', placeholder: "Dimension in mm", pattern: /^(?:\d{1,4}(?:\.\d{1,2})?|\.\d{1,2})$/, maxLength: 7 },
            { name: 'ppk', label: 'PPK', type: 'text', placeholder: "Enter in value" },
