export const machineFields = {
    Cutting: {
        BandSaw: [
            ...
            { name: 'max_square_in_mm', label: 'Max Square', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        PowerHackSaw: [
            ...
            { name: 'max_square_in_mm', label: 'Max Square', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'stroke_length_in_mm', label: 'Stroke Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_speed_strokes', label: 'No. Of Speed Strokes', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'blade_thickness_in_mm', label: 'Blade Thickness', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        CircularSaw: [
            ...
            { name: 'max_diameter_round_in_mm', label: 'Max Diameter Round', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'min_square_in_mm', label: 'Min Square', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_square_in_mm', label: 'Max Square', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'min_cut_feed_length_in_mm', label: 'Min Cut Feed Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_cut_feed_length_in_mm', label: 'Max Cut Feed Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'cutter_motor_power_in_kw', label: 'Cutter Motor Power', type: 'text', placeholder: "Enter in Kw", pattern: 'real' },
            { name: 'cutting_speed_in_mmin', label: 'Cutting Speed', type: 'text', placeholder: "Enter in m/min", pattern: 'real' },
            { name: 'machineHourRate', label: 'Machine Hour Rate', type: 'text', placeholder: "Enter machine hour rate", pattern: 'real' },
    ...
    Drilling: {
        ConventionalDrillingMachine: [
            ...
            { name: 'max_length_in_mm', label: 'Max Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'spindle_tape', label: 'Spindle Tape', type: 'text', placeholder: "Dimension in MT3", pattern: 'real' },
            { name: 'no_of_spindle_speeds', label: 'No Of Spindle Speeds', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'spindle_travel', label: 'Spindle Travel', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
    ...
    Machining: {
        VerticalMachiningCenters: [
            ...
            { name: 'table_size', label: 'Table Size', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_load_on_the_table', label: 'Max Load_on The Table', type: 'text', placeholder: "Enter in kgs", pattern: 'real' },
            { name: 'x_axis', label: 'X-Axis', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'y_axis', label: 'Y-Axis', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'z_axis', label: 'Z-Axis', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'distance_between_spindles', label: 'Distance Between Spindles', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            ...
            { name: 'tool_shank_type', label: 'Tool Shank Type', type: 'text', placeholder: "Enter in BT40", pattern: 'real' },
    ...
    Turning: {
        ConventionalLathe: [
            ...
            { name: 'max_diameter_in_mm', label: 'Max Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_length_in_mm', label: 'Max Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_speeds', label: 'No Of Speeds', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
        ...
        CncLathe: [
            ...
            { name: 'standard_chuck_size', label: 'Standard Chuck Size', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        TurretLathe: [
            ...
            { name: 'no_of_tool_station', label: 'No Of Tool Stations', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'quill_dia_in_mm', label: 'Quill Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        Automat: [
            ...
            { name: 'max_turning_diameter_in_mm', label: 'Max Turning Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_turning_length_in_mm', label: 'Max Turning Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_thread_dia_in_mm', label: 'Max Thread Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_spindle_speeds', label: 'No Of Spindle Speeds', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'no_of_bars', label: 'Bar Loader(No Of Bars)', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
        ...
        SlidingHeadAutomat: [
            ...
            { name: 'max_turning_diameter_in_mm', label: 'Max Turning Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_turning_length_in_mm', label: 'Max Turning Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'spindle_through_hole_dia_in_mm', label: 'Spindle Through Hole Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_tools', label: 'No Of Tools(Max)', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'no_of_bars', label: 'Bar Loader(No Of Bars)', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'length_bar_in_mm', label: 'Length of the Bar(Max)', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        MultispindleAutomat: [
            ...
            { name: 'max_turning_diameter_in_mm', label: 'Max Turning Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_turning_length_in_mm', label: 'Max Turning Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_spindle', label: 'No of Spindle', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'no_of_bars', label: 'Bar Loader(No Of Bars)', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'length_bar_in_mm', label: 'Length of the Bar(Max)', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        VerticalTurningLathe: [
            ...
            { name: 'max_turning_diameter_in_mm', label: 'Max Turning Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_height_workplace_in_mm', label: 'Max Height of Workplace', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'table_dia_in_mm', label: 'Table Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_weight_workplace_in_mm', label: 'Max Weight of Workplace', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'no_of_tool_station', label: 'No Of Tool Stations', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
            { name: 'max_tool_size_dia_in_mm', label: 'Max Tool Size', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'cncControl', label: 'CNC Control', type: 'select', placeholder: "Please choose type", options: ['Fanuc', 'Siemens', 'Others'] },
            { name: 'positioning_accuracy', label: 'Positioning Accuracy', type: 'text', placeholder: "+/- in mm", pattern: 'real' },
            { name: 'repeatability', label: 'Repeatability', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'ppk', label: 'PPK', type: 'text', placeholder: "Enter in value" },
    ...
    Grinding: {
        CylindricalGrindingMachine: [
            ...
            { name: 'max_weight_workplace_in_kg', label: 'Max Weight of Workplace (in Kg/s)', type: 'text', placeholder: "Dimension in kg", pattern: 'real' },
            { name: 'max_grinding_dia_in_mm', label: 'Max Grinding Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'max_grinding_length_in_mm', label: 'Max Grinding Length', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        CenterlessGrindingMachine: [
            ...
            { name: 'grinding_wheel_width_in_mm', label: 'Grinding Wheel Width', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'grinding_wheel_dia_in_mm', label: 'Grinding Wheel Diameter', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'cncControl', label: 'CNC Control', type: 'select', placeholder: "Please choose type", options: ['Fanuc', 'Siemens'] },
            { name: 'ppk', label: 'PPK', type: 'text', placeholder: "Enter in number", pattern: /^(?:[1-9]|10)$/ },
    ...
    Milling: {
        ConventionalMillingMachine: [
            ...
            { name: 'swivel_of_table', label: 'Swivel of Table', type: 'text', placeholder: "Enter in degrees", pattern: 'real' },
            { name: 'standard_arbor_size', label: 'Standard Arbor Size', type: 'text', placeholder: "Enter in inches", pattern: 'real' },
            { name: 'longitudinal_travel', label: 'Longitudinal Travel', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'vertical_travel', label: 'Vertical Travel', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'cross_travel', label: 'Cross Travel', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'quill_spindle_dia_in_mm', label: 'Quill Spindle Dia', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
    ...
    Plastics: {
        InjectionMoulding: [
            ...
            { name: 'injection_rate_in_cc/s', label: 'Injection Rate', type: 'text', placeholder: "Enter in cc/s", pattern: 'real' },
            { name: 'hopper_capacity_in_litres', label: 'Hopper Capacity', type: 'text', placeholder: "Enter in litres", pattern: 'real' },
            { name: 'clamping_force_in_tons', label: 'Clamping Force', type: 'text', placeholder: "Enter in tons", pattern: 'real' },
            { name: 'mold_thickness_in_mm', label: 'Mold Thickness (min-max)', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'daylight_opening_in_mm', label: 'Daylight Opening', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
        ...
        BlowMouldingMachine: [
            ...
            { name: 'arctic_max_size_in_litres', label: 'Arctic Max Size', type: 'text', placeholder: "Enter in litres", pattern: 'real' },
            { name: 'production_range_in_litres', label: 'Production Range', type: 'text', placeholder: "Enter in litres", pattern: 'real' },
            { name: 'max_weight_in_kg', label: 'Maximum Weight', type: 'text', placeholder: "Enter in kg", pattern: 'real' },
            { name: 'clamping_force_in_kn', label: 'Clamping Force (in KN)', type: 'text', placeholder: "Enter in KN", pattern: 'real' },
            { name: 'mold_envelope_height_in_mm', label: 'Mold Envelope Height', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
            { name: 'width_in_mm', label: 'Width', type: 'text', placeholder: "Dimension in mm", pattern: 'real' },
