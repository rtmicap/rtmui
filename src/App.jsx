...
const ListsItems = [
  ...
  { icon: FileAddOutlined, label: 'Hire a Machine' },
  { icon: BookOutlined, label: 'View Legal Agreement' },
  { icon: ContainerOutlined, label: 'View Code of Conduct' },
  { icon: SnippetsOutlined, label: 'View Company Guidelines' },
  { icon: RestOutlined, label: 'Change Password' },
